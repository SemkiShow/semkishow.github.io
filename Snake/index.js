...
var ASM_CONSTS = {
 ...
 165833: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 165891: () => { return screen.width; },  
 165916: () => { return screen.height; },  
 165942: () => { return window.screenX; },  
 165969: () => { return window.screenY; },  
 165996: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 166049: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 166120: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 166177: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 166433: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 166504: () => { if (document.fullscreenElement) return 1; },  
 166550: () => { return window.innerWidth; },  
 166576: () => { return window.innerHeight; },  
 166603: () => { if (document.pointerLockElement) return 1; }
};
