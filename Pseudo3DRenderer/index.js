...
Module['FS_createPath']("/resources", "screenshots", true, true);
    ...
    loadPackage({"files": [{"filename": "/resources/JetBrainsMonoNerdFont-Medium.ttf", "start": 0, "end": 2285708}, {"filename": "/resources/maps/map0.txt", "start": 2285708, "end": 2285894}, {"filename": "/resources/maps/map1.txt", "start": 2285894, "end": 2286003}, {"filename": "/resources/maps/map2.txt", "start": 2286003, "end": 2286306}, {"filename": "/resources/maps/map3.txt", "start": 2286306, "end": 2286609}, {"filename": "/resources/screenshots/Pseudo3DRenderer1.png", "start": 2286609, "end": 2302826}, {"filename": "/resources/screenshots/Pseudo3DRenderer2.png", "start": 2302826, "end": 2323475}, {"filename": "/resources/screenshots/Pseudo3DRenderer3.png", "start": 2323475, "end": 2338699}, {"filename": "/resources/screenshots/Pseudo3DRenderer4.png", "start": 2338699, "end": 2355498}, {"filename": "/settings.txt", "start": 2355498, "end": 2355641}], "remote_package_size": 2355641});

  })();

// end include: /tmp/tmpsbmoy63a.js
// include: /tmp/tmp4wu3v9sy.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp4wu3v9sy.js
// include: /tmp/tmpkb6w36qz.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpkb6w36qz.js
...
var ASM_CONSTS = {
  119640: () => { if (document.fullscreenElement) return 1; },  
 119686: () => { return document.getElementById('canvas').width; },  
 119738: () => { return parseInt(document.getElementById('canvas').style.width); },  
 119806: () => { document.exitFullscreen(); },  
 119833: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 119906: () => { if (document.fullscreenElement) return 1; },  
 119952: () => { return document.getElementById('canvas').width; },  
 120004: () => { return screen.width; },  
 120029: () => { document.exitFullscreen(); },  
 120056: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 120189: () => { return window.innerWidth; },  
 120215: () => { return window.innerHeight; },  
 120242: () => { if (document.fullscreenElement) return 1; },  
 120288: () => { return document.getElementById('canvas').width; },  
 120340: () => { return parseInt(document.getElementById('canvas').style.width); },  
 120408: () => { if (document.fullscreenElement) return 1; },  
 120454: () => { return document.getElementById('canvas').width; },  
 120506: () => { return screen.width; },  
 120531: () => { return window.innerWidth; },  
 120557: () => { return window.innerHeight; },  
 120584: () => { if (document.fullscreenElement) return 1; },  
 120630: () => { return document.getElementById('canvas').width; },  
 120682: () => { return screen.width; },  
 120707: () => { document.exitFullscreen(); },  
 120734: () => { if (document.fullscreenElement) return 1; },  
 120780: () => { return document.getElementById('canvas').width; },  
 120832: () => { return parseInt(document.getElementById('canvas').style.width); },  
 120900: () => { document.exitFullscreen(); },  
 120927: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 120985: () => { return screen.width; },  
 121010: () => { return screen.height; },  
 121036: () => { return window.screenX; },  
 121063: () => { return window.screenY; },  
 121090: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 121143: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 121214: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 121271: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 121527: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 121598: () => { if (document.fullscreenElement) return 1; },  
 121644: () => { return window.innerWidth; },  
 121670: () => { return window.innerHeight; },  
 121697: () => { if (document.pointerLockElement) return 1; }
};
